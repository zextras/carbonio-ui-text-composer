	...
	describe('createTinyMCESetup', () => {
		...
		it('should return a setup function', () => {
			const setup = createTinyMCESetup({
				...
				selectImageTooltip: SELECT_IMAGE_TOOLTIP
			});
